...
const storeHref = `/store?type=${encodeURIComponent("교재")}&exam=${encodeURIComponent("내신")}&subject=${encodeURIComponent("수학")}`;

const highlights = [
  "학교 내신 출제 흐름에 맞춘 개념 정리",
  "단원별 필수 유형을 빠르게 점검",
  "시험 직전 복습에 최적화된 구성",
];

export default function ConnectNaesinMathPage() {
  return (
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-6xl px-4 py-16 md:py-24">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-4 text-[28px] md:text-[42px] font-bold leading-tight">CONNECT 내신 수학</h1>
              <p className="mt-4 text-[13px] md:text-[15px] text-white/70 leading-relaxed">
                내신 성적을 빠르게 끌어올릴 수 있도록 학교 시험 중심으로 구성한 실전형 교재입니다.
              </p>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div>
                ...
                <p className="mt-4 text-[13px] md:text-[15px] text-white/60 leading-relaxed">
                  내신 시험 범위가 방대해 정리와 반복이 필요한 학생에게 추천합니다.
                </p>
              </div>
