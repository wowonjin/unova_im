...
const storeHref = `/store?type=${encodeURIComponent("교재")}&exam=${encodeURIComponent("수능")}&subject=${encodeURIComponent("수학")}`;

const highlights = [
  "수능·평가원 기출 기반 핵심 개념 정리",
  "문항 접근 스킬과 풀이 루틴을 체계화",
  "실전 감각을 높이는 난이도별 구성",
];

export default function ConnectSuneungMathPage() {
  return (
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-6xl px-4 py-16 md:py-24">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-4 text-[28px] md:text-[42px] font-bold leading-tight">CONNECT 수능 수학</h1>
              <p className="mt-4 text-[13px] md:text-[15px] text-white/70 leading-relaxed">
                수능 수학에서 요구하는 개념과 스킬을 빠르게 정리하고, 실전에 적용할 수 있도록 설계한 교재입니다.
              </p>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div>
                ...
                <p className="mt-4 text-[13px] md:text-[15px] text-white/60 leading-relaxed">
                  개념은 알고 있지만 실전 점수로 연결되지 않는 학생, 평가원 스타일 문항에서 약한 학생에게 추천합니다.
                </p>
              </div>
